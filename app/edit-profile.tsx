...
export default function EditProfileScreen() {
    ...
    if (loading) return <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }} edges={['top']}><LoadingScreen variant="edit-profile" message="Loading Profile..." /></SafeAreaView>;
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }} edges={['top']}>
            ...
            <SearchableSelectionModal visible={titleModalVisible} onClose={() => setTitleModalVisible(false)} onSelect={(val) => updateProfileField('title', val)} title="Select Title" options={PROFESSIONAL_TITLES} placeholder="Search title..." currentValue={profile.title} />
            <SearchableSelectionModal visible={suffixModalVisible} onClose={() => setSuffixModalVisible(false)} onSelect={(val) => updateProfileField('professional_suffix', val)} title="Select Suffix" options={PROFESSIONAL_SUFFIXES} placeholder="Search suffix..." currentValue={profile.professional_suffix} />
            ...
            >
                ...
                >
                    ...
                    <View style={{ backgroundColor: theme.colors.card, borderColor: theme.colors.border, borderWidth: 1, borderRadius: 24, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 }}>
                        <AuthInput label="First Name" value={profile.first_name} placeholder="Enter your first name" onChange={(t: string) => updateProfileField('first_name', t)} required icon={UserIcon} errorKey="firstName" theme={theme} errors={errors} setErrors={setErrors} visibleTooltip={visibleTooltip} setVisibleTooltip={setVisibleTooltip} />
                        <AuthInput label="Middle Name" value={profile.middle_name} placeholder="Enter your middle name" onChange={(t: string) => updateProfileField('middle_name', t)} icon={UserIcon} theme={theme} errors={errors} setErrors={setErrors} visibleTooltip={visibleTooltip} setVisibleTooltip={setVisibleTooltip} />
                        <AuthInput label="Last Name" value={profile.last_name} placeholder="Enter your last name" onChange={(t: string) => updateProfileField('last_name', t)} required icon={UserIcon} errorKey="lastName" theme={theme} errors={errors} setErrors={setErrors} visibleTooltip={visibleTooltip} setVisibleTooltip={setVisibleTooltip} />
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
