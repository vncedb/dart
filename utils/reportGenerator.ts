...
export const generateReport = async (options: ReportData) => {
  const { userName, userTitle, reportTitle, period, data, style, paperSize } = options;
      ...
      <head>
        ...
        <style>
          ...
          .header { 
            ...
            padding-bottom: 20px; border-bottom: 3px solid ${t.primary}; margin-bottom: 30px;
          }
          .title { font-size: 26px; font-weight: 800; color: ${t.primary}; text-transform: uppercase; letter-spacing: 1px; }
      ...
      <body>
        <div class="header">
          <div>
            ...
            <div class="subtitle">Generated via DART App</div>
          </div>
          <div style="text-align: right;">
            <div class="label">PERIOD</div>
            <div style="font-size: 14px; font-weight:bold; color: ${t.primary};">${period}</div>
          </div>
        </div>
